'use strict';
define(['jquery'], function($) {   // exports as requirejs module
    ...
    Game.prototype = {
        /**
         * Build the game Table containing 9x9 input matrix
         */
        buildGUI: function() {
            var $td, $tr, sectIDi, sectIDj,
                $table = $( '<table>' )
